...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        'See https://github.com/iamsamkhan/pytorch_mpiigaze_demo/ptgaze/data/configs/eth-xgaze.yaml'
    )
    parser.add_argument(
        '--mode',
        type=str,
    ...
    parser.add_argument(
        ...
        'See https://github.com/iamsamkkhan/pytorch_mpiigaze_demo/ptgaze/data/calib/sample_params.yaml'
    )
    parser.add_argument(
        '--output-dir',
        '-o',
